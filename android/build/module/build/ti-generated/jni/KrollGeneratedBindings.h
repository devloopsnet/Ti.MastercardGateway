	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"net.devloops.mastercard.gateway.TiMastercardGatewayModule", ::net::devloops::mastercard::gateway::TiMastercardGatewayModule::bindProxy, ::net::devloops::mastercard::gateway::TiMastercardGatewayModule::dispose}
			};
