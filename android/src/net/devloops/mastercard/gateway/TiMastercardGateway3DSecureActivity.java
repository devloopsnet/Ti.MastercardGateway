...
public class TiMastercardGateway3DSecureActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        _layout = (LinearLayout) View.inflate(this, RHelper.getLayout("activity_3dsecure"), null);
        setContentView(_layout);

        // init toolbar
        toolbar = findViewById(RHelper.getId("toolbar"));
        toolbar.setNavigationOnClickListener(view -> onBackPressed());

        // init web view
        webView = findViewById(RHelper.getId("webview"));
    ...
    String getDefaultTitle() {
        return getString(RHelper.getString("gateway_3d_secure_authentication"));
    }
    ...
    WebViewClient buildWebViewClient() {
        return new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                webViewUrlChanges(Uri.parse(request.getUrl().toString()));
                return true;
            }
        };
    }
